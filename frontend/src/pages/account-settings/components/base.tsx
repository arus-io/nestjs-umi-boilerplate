      ...
      <div className={styles.baseView} ref={this.getViewDom}>
        <div className={styles.left}>
          ...
          >
            <Form.Item
              name="email"
              label={formatMessage({ id: 'account-settings.basic.email' })}
              rules={[
                {
                  required: true,
            ...
            <Form.Item
              name="name"
              label={formatMessage({ id: 'account-settings.basic.nickname' })}
              rules={[
                {
                  required: true,
            ...
            <Form.Item
              name="profile"
              label={formatMessage({ id: 'account-settings.basic.profile' })}
              rules={[
                {
                  required: true,
            ...
            <Form.Item
              name="country"
              label={formatMessage({ id: 'account-settings.basic.country' })}
              rules={[
                {
                  required: true,
            ...
            <Form.Item
              name="geographic"
              label={formatMessage({ id: 'account-settings.basic.geographic' })}
              rules={[
                {
                  required: true,
            ...
            <Form.Item
              name="address"
              label={formatMessage({ id: 'account-settings.basic.address' })}
              rules={[
                {
                  required: true,
            ...
            <Form.Item
              name="phone"
              label={formatMessage({ id: 'account-settings.basic.phone' })}
              rules={[
                {
                  required: true,
